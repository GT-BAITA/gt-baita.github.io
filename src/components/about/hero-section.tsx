    ...
    <>
      <section id="init" className="pt-24 pb-12 md:pt-40 md:pb-50 lg:pb-10 mx-auto">
        <div className="flex items-start flex-col gap-10 max-w-[800px]">
          <p className="uppercase text-neutral-500 text-base font-geist">Sobre o projeto</p>
          ...
          <p className="text-xl text-neutral-500 leading-tight font-geist max-w-[573px]">
            ...
            <br /> do acesso digital de milhões de pesquisadores, professores <br />e estudantes em
            todo o país.
          </p>
        </div>
      </section>
